...
public class Global {
    ...
    public static final String OPERACION_CORRECTA = "Operación realizada correctamente";
    public static final String OPERACION_INCORRECTA = "No se ha podido realizar la operación";
